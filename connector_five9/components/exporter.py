...
class Five9ExporterBase(AbstractComponent):

    _name = 'five9.exporter.base'
    _inherit = ['base.exporter', 'base.five9.connector']
    _usage = 'record.exporter'

    def __init__(self, working_context):
        super(Five9ExporterBase, self).__init__(working_context)
        self.binding = None
    ...
    def run(self, binding, *args, **kwargs):
        ...
        Args:
            binding (Five9Binding): Binding record to export.
        """
...
class Five9Exporter(AbstractComponent):
    """A common flow for all Five9 exports."""

    _name = 'five9.exporter'
    _inherit = 'five9.exporter.base'

    def __init__(self, working_context):
        super(Five9Exporter, self).__init__(working_context)
        self.binding = None
    ...
    def _retry_unique_violation(self):
        ...
        record created by :meth:`_export_dependency`), resulting in::
            ...
            constraint "five9_product_product_odoo_uniq"
        ...
        Warning:
            ...
            prevent 2 bindings for the same Five9 record.
        """
        try:
            yield
    ...
    def _export_dependency(self, relation, binding_model,
                           ...
                           binding_field='five9_bind_ids',
                           binding_extra_vals=None):
        """Export a dependency.

        The exporter class is a subclass of ``Five9Exporter``. The
        ...
        if wrap and hasattr(relation, binding_field):
            ...
            # five9.product.product and we are exporting it, but we need to
            ...
            # If five9_bind_ids does not exist we are typically in a
    ...
    def _run(self, fields=None):
        ...
        return _('Record exported with ID %s on Five9.') % self.external_id
